...
public class TopicosController {
	...
	@GetMapping
	public Page<TopicoDto> lista(@RequestParam(required = false) String nomeDoCurso, @RequestParam 
			int pagina, @RequestParam(name = "qtd") int quantidade, @RequestParam String ordenacao) {
		PageRequest paginacao = PageRequest.of(pagina, quantidade, Direction.ASC, ordenacao);
